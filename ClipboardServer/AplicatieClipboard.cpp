...
void __fastcall TfClipboard::btnPasteClick(TObject *Sender)
{
        ...
        ServerSocket->Socket->Connections[0]->SendText("PASTE|"+text);
...
void __fastcall TfClipboard::btnDeleteClick(TObject *Sender)
{
        ...
        if(lstBox->ItemIndex!=-1)
        {
                ...
                ServerSocket->Socket->Connections[0]->SendText(textTrimis);
...
void __fastcall TfClipboard::ServerSocketClientRead(TObject *Sender,
